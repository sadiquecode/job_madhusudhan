...
<div class="container my-5">
        <div class="jobform">
            <div class="py-5">
                <a href="#" class="btn d-inline-flex align-items-center fw-bold btn-primary gap-2"><svg
            ...
            <div class="container">
                <div class="row pb-5">
                    <div class="col-4 text-center">
                        <button type="button" class="btn btn-danger position-relative fw-semibold px-lg-4 py-lg-2 px-2">
                            CBSE
                            <span
