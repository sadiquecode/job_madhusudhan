...
<div class="col-sm-4 col-3">
    <h4 class="page-title">All Speciality</h4>
</div>
<div class="col-sm-8 col-9 text-right m-b-20">
    <a href="#" class="btn btn-primary btn-rounded float-right" data-toggle="modal" data-target="#add_grade"><i class="fa fa-plus"></i> Add Speciality</a>
</div>
</div>
@if ($errors->any())
...
<div class="col-md-12">
    <div class="table-responsive">
        <table class="table table-striped custom-table datatable"  id="teachme_table">
            ...
            <tbody>
                @foreach ($speciality as $index => $grade)
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td>{{ $grade->title }}</td>
                ...
                <div id="delete_grade_{{$grade->id}}" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content modal-md">
                            ...
                            <form action="{{ route('speciality.destroy', $grade->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content modal-lg">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="m-b-30" action="{{ route('speciality.update', $grade->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-sm-12">
            ...
            <select class="select floating" name="data_types_id">
                ...
                @endforeach
                                ...
                                <div class="m-t-20 text-center mb-5">
                                    <button type="submit" class="btn btn-primary btn-lg">Update Speciality</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
@else
<p class="p-4">{{'Speciality Not Found!'}}</p>
@endif
</div>
</div>
</div>
...
<div class="modal-body">
<form class="m-b-30" action="{{ route('speciality.store') }}" method="POST" enctype="multipart/form-data">
@csrf
<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
...
<div class="m-t-20 text-center mb-5">
    <button type="submit" class="btn btn-primary btn-lg">Create Speciality</button>
</div>
</form>
</div>
</div>
